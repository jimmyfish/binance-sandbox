            ...
            <a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="javascript:void(0);"
                ...
                <div class="user-nav d-sm-flex d-none">
                    ...
                    <span class="user-status">
                        @if (Auth::check())
                            Balance: <span
                                class="text-primary"><small>$</small>&nbsp;<strong>{{ number_format(Auth::user()->balance, 2) }}</strong></span>
                        @endif
                    </span>
                </div>
                <span class="avatar">
                    ...
                    <img class="round"
                        src="https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Fpre00.deviantart.net%2F34e0%2Fth%2Fpre%2Fi%2F2016%2F043%2Fe%2F8%2Farale_norimaki_by_camanalli-d9rfk0n.png&f=1&nofb=1"
